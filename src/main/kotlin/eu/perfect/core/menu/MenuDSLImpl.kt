package eu.perfect.core.menu

import eu.perfect.core.menu.events.*
import eu.perfect.core.menu.slot.Slot
import eu.perfect.core.menu.slot.SlotDSL
import eu.perfect.core.menu.slot.SlotDSLImpl
import eu.perfect.core.menu.slot.SlotEventHandlerDSL
import eu.perfect.core.utils.extensions.WithPlugin
import eu.perfect.core.utils.extensions.task
...
class MenuDSLImpl(
    ...
    private fun updateSlotOnlyPos(pos: Int, slot: Slot, player: Player, inventory: Inventory) {
        val slotUpdate =
            MenuPlayerSlotUpdate(this, pos, slot, player, inventory)
        ...
        for (player in players) {
            ...
            try {
                ...
                for (i in rangeOfSlots()) {
                    ...
                    val render =
                        MenuPlayerSlotRender(this, i, slot, player, inv)
