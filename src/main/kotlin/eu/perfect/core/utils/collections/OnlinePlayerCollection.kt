package eu.perfect.core.utils.collections

import eu.perfect.core.utils.PlayerComparator
import eu.perfect.core.utils.extensions.*
...
class OnlinePlayerList(override val plugin: Plugin) : LinkedList<Player>(),
...
class OnlinePlayerSet(override val plugin: Plugin) : TreeSet<Player>(PlayerComparator),
    OnlinePlayerCollection {
...
interface OnlinePlayerCollection : MutableCollection<Player>,
    KListener<Plugin> {
...
class OnlinePlayerMap<V>(override val plugin: Plugin) : TreeMap<Player, V>(PlayerComparator),
    KListener<Plugin> {
